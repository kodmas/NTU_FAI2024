...
def main():
    ...
    # print("shape of X_train_transformed_pca: ", X_train_transformed_pca.shape)
    # print("shape of X_train_transformed_ae: ", X_train_transformed_ae.shape)
    # print("shape of X_train_transformed_deno_ae: ", X_train_transformed_deno_ae.shape)
    ...
    # # Directly show the reconstructed image compared to the original image without reshaping

    # fig, axs = plt.subplots(1, 2)
    # axs[0].imshow(img_vec.reshape(61,80), cmap='gray')
    # axs[0].set_title('Original Image')
    # axs[1].imshow(img_reconstruct_pca.reshape(61,80), cmap='gray')
    # axs[1].set_title('Reconstructed Image with PCA')
    
    # plt.savefig('reconstructed_image_pca.png')
    # plt.show()

    # fig, axs = plt.subplots(1, 2)
    # axs[0].imshow(img_vec.reshape(61,80), cmap='gray')
    # axs[0].set_title('Original Image')
    # axs[1].imshow(img_reconstruct_ae.reshape(61,80), cmap='gray')
    # axs[1].set_title('Reconstructed Image with Autoencoder')
    
    # plt.savefig('reconstructed_image_ae.png')
    # plt.show()
    
    # fig, axs = plt.subplots(1, 2)
    # axs[0].imshow(img_vec.reshape(61,80), cmap='gray')
    # axs[0].set_title('Original Image')
    # axs[1].imshow(img_reconstruct_deno_ae.reshape(61,80), cmap='gray')
    # axs[1].set_title('Reconstructed Image with DenoisingAutoencoder')
    
    # plt.savefig('reconstructed_image_deno_ae.png')
    # plt.show()
